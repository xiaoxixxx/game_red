<template>
	<view style="background: url('/static/actIcon/sign/signBg.png') no-repeat 100%;min-height: 100vh;">
		...
		<view class="pdlr50 pt33">
			...
			<view class="f50 mt60 text_bold" :style="{color:store.$state.secondColor}">Sign in</view>
			...
			<view class="mt57 botBox">
				<view class="center pt40">
					...
					<view class="text-white">sign Rules</view>
					<view class="center">
						<view class="dors"></view>
						<view class="line"></view>
					</view>
		...
		<view v-show="showMask" class="mask center flex-col">
			...
			<IconFont name="failure" color="#fff" size="40" class="mt20" @click="closeHandle"></IconFont>
