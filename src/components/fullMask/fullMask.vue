<template>
	<view class="mask  " @click="closeHandle" v-show="show">
		<view class="maskContent  " @tap.stop :class="!show ? 'animate__fadeInUp' : ''">
				...
				<view class="mainBox  ">
					<swiper :indicator-dots="false" :autoplay="false" :interval="2000" :duration="1000" next-margin="20"
						...
						<swiper-item v-for="(item, index) in maskList" :key="index" class="maskItem center">
							<view v-html="item.content"  style="padding: 40rpx 0 0 0; width: 100%;height: 100%;" ></view>
						</swiper-item>
					</swiper>
				</view>
