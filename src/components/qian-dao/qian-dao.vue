		...
		<view class="header">
			<view class="btn-group">
				<view class="btn btn-prev" @click="onSwitchPrevMonth()">
					...
					<IconFont name="rect-left" size="20" color="#fff"></IconFont>
				</view>
				<view class="current-date">{{ currentDate }}</view>
				<view class="btn btn-next" @click="onSwitchNextMonth()">
					<IconFont name="rect-right" size="20" color="#fff"></IconFont>
		...
		<view class="body">
		   ...
		   -->
					<view class="flex flex-direction justify-center align-center" :class="day.checked?'checkedDay':''"
						...
						<view> {{day.day}}</view>
						<IconFont name="Check" class="phoneCheck animate__animated animate__fadeIn "
							v-show="day.checked" color="#fff" style="margin-top: -10rpx;"></IconFont>
					</view>
				</view>
			</view>
		</view>
